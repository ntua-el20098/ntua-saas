...
import { LogsPage } from "@/components/component/logs-page";
...
export default function Page() {
  ...
  if (status === "authenticated") {
    ...
    <div className="w-16 h-16 border-4 border-white-500 border-t-transparent border-solid rounded-fuLogsPagell animate-spin"></div>
</div>
  } 
  else {
    return <GoogleLogin />;
